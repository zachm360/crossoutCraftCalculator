...
function getSpitfireCost() {
    ...
    let spitfireMarketValue = prompt("What is the current market price of a Spitfire?")
    if (spitfireCost >= spitfireMarketValue) alert("You should buy the Spitfire")
    else alert("You should craft a Spitfire")
    console.log("The cost to craft a Spitfire Machine Gun is " + spitfireCost);
}
